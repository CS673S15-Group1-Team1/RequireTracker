...
urlpatterns = patterns('',
    ...
    url(r'^newiteration/(?P<projectID>\d+)', iterations.new_iteration),
    url(r'^edititeration/(?P<projectID>\d+)/(?P<iterationID>\d+)', iterations.edit_iteration),
    url(r'^deleteiteration/(?P<projectID>\d+)/(?P<iterationID>\d+)', iterations.delete_iteration),
    url(r'^iterations/(?P<projectID>\d+)', iterations.list_iterations_for_project),
    url(r'^iterationswithselection/(?P<projectID>\d+)/(?P<iterationID>\d+)', iterations.list_iterations_for_project_with_selection),
    ...
    url(r'^movestorytoicebox/(?P<projectID>\d+)/(?P<storyID>\d)', stories.move_story_to_icebox),
    url(r'^movestorytoiter/(?P<projectID>\d+)/(?P<storyID>\d+)/(?P<iterationID>\d+)', stories.move_story_to_iteration),
